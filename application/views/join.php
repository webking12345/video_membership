...
<div id="main">
  <div class="container">
    <div class="row mt-4">
      <div class="col-sm-12">
        <h1 class="title font-color-light-blue text-center mb-0 mt-0">join us!</h1>
                    ...
                    <div class="form-group mb-1">
                      ...
                      <div class="input-icons"> 
                        <i class="m-auto fa fa-user icon"></i> 
                          <input id="username" name="username" type="text" required class="form-control focus <?php echo $theme ? "brightly" : "darkly" ?>-form-control" autofocus> 
                      </div>                  
                    </div>
                    <div class="form-group mb-1">
                  ...
                  <div class="col-sm-6 ml-auto mr-auto">
                    <div id="reg-description" class="reg-description row h-100">
                      <div class="col-sm-12 my-auto font-color-light-blue">
                        <div class="messages">
                            <?php echo isset($description) ? nl2br($description) : ''; ?>                  
                        </div>  
                      </div>
                    </div>
                  </div>
